...
import { getUserRoleObj, hasUserPermission, isOwnerUser } from '../utils/auth';
...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const canViewStaffDirectory = isOwner || canManageStaff || hasUserPermission(currentUser, 'canViewStaffDirectory');
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-20 gap-2">
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              <div>
                ...
                <p className="text-[11px] sm:text-xs text-zinc-400 font-medium hidden md:block">
                  {siteSettings.siteSubtitle || 'النظام الرسمي للوائح المحاسبة ومخالفات الرول بلاي'}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
              ...
              <div className="flex items-center gap-1.5">
                ...
                {/* Admin Directory Button (For users with canViewStaffDirectory) */}
                {(isOwner || canViewStaffDirectory) && (
                  <button
                    type="button"
                    ...
                    title="جدول أعضاء الإدارة، الرتب، والمسؤوليات"
                  >
                    <Users className="w-4 h-4 text-orange-400" />
                    <span className="hidden md:inline">جدول الإدارة</span>
                  </button>
                )}
      ...
      {/* Owner-Only Site Settings Modal */}
      <SiteSettingsModal
